...
export class ReviewResolverBase {
  ...
  async getWig(@graphql.Parent() parent: Review): Promise<Wig | null> {
    const result = await this.service.getWig(parent.id);
